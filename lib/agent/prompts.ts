  ...
  coverLetter: {
    ...
    guide:
      [
        ...
        "5. set_cover_letter 的 body 放正式版正文；shortVersion 可提供 100-180 字聊天开场白；highlights 列出这封信真实引用的简历依据。",
        "6. 用户要求改语气、缩短、换场景、突出某段经历时，重新调用 set_cover_letter 更新左侧文档，不要输出一长段替代正文后就结束。",
